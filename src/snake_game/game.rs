...
/// 上边框颜色
const T_BORDER_COLOR: Color = [0.0000, 0.0, 0.0, 0.6];
/// 下边框颜色
const B_BORDER_COLOR: Color = [0.0000, 0.0, 0.0, 0.6];
/// 左边框颜色
const L_BORDER_COLOR: Color = [0.0000, 0.0, 0.0, 0.6];
/// 右边框颜色
const R_BORDER_COLOR: Color = [0.0000, 0.0, 0.0, 0.6];
